...
/* IMAGE STEGANOGRAPHY : ImageSteno.java
 * 
 * This source code form is protected under GPL v2.0.
 * To read more about the license, follow the link:
 * http://www.gnu.org/licenses/gpl-2.0.html
 * 
 * Created by Manik Singh as a project
 * during the summer training.
 * https://github.com/maniksingh92-xx/simple-steganography
 * 
 * Initiating date : 7-JUL-2014
 * 
 * >> ImageSteno.java contains two methods encode(), for
...
public class ImageStego {
	...
	public boolean encode(BufferedImage input, BufferedImage output, int width, int height, String msg, String outputName) {
	...
	private boolean isEncoded(BufferedImage input, int width, int height) { //Check for "!encoded!" at starting
	...
	private int getEncodedLength(BufferedImage input, int width, int height) { //method to get actual length of message encoded
